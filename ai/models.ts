...
export const models: Model[] = [
  ...
  {
    value: 'scira-minimax-m3',
    label: 'MiniMax M3',
    description: "MiniMax's latest flagship model with 512K context and image input support",
    vision: true,
    reasoning: true,
    experimental: false,
    category: 'Pro',
  ...
  },
  {
    ...
    label: 'MiniMax M2.7',
    description: "MiniMax's Peak Performance. Ultimate Value. Master the Complex",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Pro',
  ...
  {
    value: 'scira-minimax-m2.7-highspeed',
    label: 'MiniMax M2.7 Highspeed',
    description: "MiniMax M2.7 — same performance, faster and more agile",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Pro',
